...
def handle_user_input(user_question):
    ...
    if vector_store:
        ...
        st.error("No vector store found. Please upload and process PDF files first.")

# Main function to run the Streamlit app
def main():
    # Set page configuration and title
    st.set_page_config(page_title="Bateel AI Assistant", layout="wide")
    st.title("Bateel AI Assistant")
    ...
    for dialogue in st.session_state.history:
        ...
        answer_html = f'<p class="answer">Bateel AI: {dialogue["ai_response"]}</p>'
